			...
			$button.on( 'click', function(e) {
				...
				jQuery.post( TRX_ADDONS_STORAGE['ajax_url'], {
					...
					if ( rez.error || rez.data.message ) {
						...
						$form.find( '.sc_tgenerator_message' ).html( msg ).addClass( 'sc_tgenerator_message_show' );
						setTimeout( function() {
							$form.find( '.sc_tgenerator_message' ).removeClass( 'sc_tgenerator_message_show' );
						}, trx_addons_apply_filters( 'trx_addons_filter_sc_tgenerator_message_timeout', 8000 ) );
					}
				} );
			} );
