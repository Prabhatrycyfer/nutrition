...
if ( ! function_exists( 'trx_addons_sc_chat_generate_text' ) ) {
	...
	function trx_addons_sc_chat_generate_text() {
		...
		$limit_per_request = trx_addons_get_option( 'ai_helper_sc_chat_limit_per_request' );
		$limit_per_hour = trx_addons_get_option( 'ai_helper_sc_chat_limit_per_hour' );
		$limit_per_visitor = trx_addons_get_option( 'ai_helper_sc_chat_limit_per_visitor' );
