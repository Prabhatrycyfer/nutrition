...
if ( ! function_exists( 'fortius_woocommerce_get_css' ) ) {
	add_filter( 'fortius_filter_get_css', 'fortius_woocommerce_get_css', 10, 2 );
	function fortius_woocommerce_get_css( $css, $args ) {
...
$fdir = fortius_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
