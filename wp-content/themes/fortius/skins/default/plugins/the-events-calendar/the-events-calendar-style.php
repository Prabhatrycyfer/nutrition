...
if ( ! function_exists( 'fortius_tribe_events_get_css' ) ) {
	add_filter( 'fortius_filter_get_css', 'fortius_tribe_events_get_css', 10, 2 );
	function fortius_tribe_events_get_css( $css, $args ) {
