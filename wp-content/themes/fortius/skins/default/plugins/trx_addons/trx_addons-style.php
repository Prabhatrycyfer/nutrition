...
if ( ! function_exists( 'fortius_trx_addons_get_css' ) ) {
	add_filter( 'fortius_filter_get_css', 'fortius_trx_addons_get_css', 10, 2 );
	function fortius_trx_addons_get_css( $css, $args ) {
