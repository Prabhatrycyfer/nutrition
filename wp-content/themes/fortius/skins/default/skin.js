...
(function() {
	...
	jQuery( document ).on(
		'action.scroll_fortius', function() {
	...
	jQuery( document ).on(
		'action.resize_fortius', function() {
			extra_margin_top_video_popup_button();
			fortius_skin_post_header_init();
			skin_add_custom_width_filter_list();
		}
	...
	jQuery( '.fortius_woocommerce_filters_button,.sidebar > .sidebar_close,.sidebar_overlay' ).on( 'click', function(e) {
