 ...
 *
 * @package FORTIUS
 * @since FORTIUS 1.0.39
 */

// Additional info
if ( fortius_is_off( fortius_get_theme_option( 'header_mobile_hide_info' ) ) ) {
	$fortius_info = fortius_get_theme_option( 'header_mobile_additional_info' );
	if ( '' != $fortius_info ) {
			...
			<div class="content_wrap">
				<div class="columns_wrap">
					<div class="sc_layouts_column sc_layouts_column_align_center sc_layouts_column_icons_position_left column-1_1"><div class="sc_layouts_item">
						<?php
						fortius_show_layout( $fortius_info );
						?>
						</div><!-- /.sc_layouts_item -->
	...
	<div class="content_wrap">
		<div class="columns_wrap columns_fluid">
			<div class="sc_layouts_column sc_layouts_column_align_left sc_layouts_column_icons_position_left sc_layouts_column_fluid column-1_3">
				<?php
				// Logo
				if ( fortius_is_off( fortius_get_theme_option( 'header_mobile_hide_logo' ) ) ) {
					?>
					<div class="sc_layouts_item">
						<?php
						set_query_var( 'fortius_logo_args', array( 'type' => 'mobile_header' ) );
				...
				if ( fortius_exists_trx_addons() ) {
					...
					if ( fortius_is_off( fortius_get_theme_option( 'header_mobile_hide_login' ) ) ) {
						ob_start();
						do_action(
							'fortius_action_login', array(
								'text_login'  => false,
								'text_logout' => false,
							)
						);
					...
					// Display cart button
					if ( fortius_is_off( fortius_get_theme_option( 'header_mobile_hide_cart' ) ) ) {
						ob_start();
					...
					if ( fortius_is_off( fortius_get_theme_option( 'header_mobile_hide_search' ) ) ) {
						ob_start();
						do_action(
