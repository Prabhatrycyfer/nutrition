...
WordPress version: required at least 5.0, tested up to 6.0.2
...
Please install and activate it before starting to use the theme Fortius.
...
Theme documentation is available on https://fortius.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Fortius is Fontello.
